<template>
  ...
  >
    ...
    <NFlex class="h-[40vh] overflow-auto" vertical>
      <NCard title="样式与喜好 :" :bordered="false" size="small" headerClass="px-2!" contentClass="pb-0!">
        <NList size="small">
          <NListItem>
      ...
      <NCard title="配置 :" :bordered="false" size="small" headerClass="px-2!" contentClass="pb-0!">
        <NList size="small">
          <NListItem>
